...
public class BookDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Leer = findViewById(R.id.button_view_more);
        ...
        loadBookReviews();
        //Configurar para abrir la URL
        Intent intURL = getIntent();
        bookUrl = intURL.getStringExtra("book_url"); // Asegúrate de pasar la URL del libro
        // Configura el botón de leer para abrir el navegador
        Leer.setOnClickListener(v -> openBookUrl());
    ...
    private void guardarEnFavoritos(String bookTitle, String bookImageUrl, String bookDescription, String bookCategory, int bookId) {
        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            ...
            String libroFav = bookTitle + "|" + bookImageUrl + "|" + bookDescription + "|" + bookCategory + "|" + averageRating + "|" + bookId + "|" + bookUrl;
