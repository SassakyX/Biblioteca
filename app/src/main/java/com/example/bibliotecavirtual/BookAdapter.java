...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.BookViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        holder.bookRating.setText(String.format("Rating: %.1f", book.getAverageRating())); // Mostrar el promedio de calificación
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView bookRating; // Nueva vista para mostrar el promedio de calificación
        ImageView bookImage;
        ...
        public BookViewHolder(@NonNull View itemView) {
            ...
            bookRating = itemView.findViewById(R.id.book_rating); // Vincular la nueva vista
